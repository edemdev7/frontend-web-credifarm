...
const BassinDetails: FC<BassinDetailsProps> = ({ isOpen, onClose, bassin }) => {
  ...
  const getFakeRecoltes = () => ([
    { id: 1, date_recolte_prevue: new Date(Date.now() + 10 * 86400000 as number).toISOString(), quantite_prevue: 500, type_poisson: 'Tilapia', observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
    { id: 2, date_recolte_prevue: new Date(Date.now() + 5 * 86400000 as number).toISOString(), quantite_prevue: 300, type_poisson: 'Silure', observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
    { id: 3, date_recolte_prevue: new Date(Date.now() + 2 * 86400000 as number).toISOString(), quantite_prevue: 200, type_poisson: 'Carpe', observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
  ]);
  const getFakeIntrants = () => ([
    { id: 1, date_avance_prevue: new Date(Date.now() + 12 * 86400000 as number).toISOString(), montant_avance: 120000, type_intrant: 'Alimentation', quantite_intrant: 100, observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
    { id: 2, date_avance_prevue: new Date(Date.now() + 6 * 86400000 as number).toISOString(), montant_avance: 80000, type_intrant: 'Engrais', quantite_intrant: 50, observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
    { id: 3, date_avance_prevue: new Date(Date.now() + 1 * 86400000 as number).toISOString(), montant_avance: 50000, type_intrant: 'Médicaments', quantite_intrant: 20, observations: '', statut: 'PLANIFIE', date_creation: new Date().toISOString() },
  ]);
      ...
      <Card>
        ...
        <CardBody>
          <Table aria-label="Calendrier de récolte">
            ...
            <TableBody>
              {getFilteredRecolte().map((recolte) => (
      ...
      <Card>
        ...
        <CardBody>
          <Table aria-label="Calendrier d'avance sur intrants">
            ...
            <TableBody>
              {getFilteredIntrants().map((intrant) => (
