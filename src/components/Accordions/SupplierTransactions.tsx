...
const SupplierTransactions: React.FC = () => {
    ...
    const fetchSupplierTransactions = async () => {
      if (selectedSupplier) {
        try {
          ...
          setSupplierName(selectedSupplier.displayName);
        } catch (error) {
          console.error(error);
        } finally {
          setLoading(false);
          ...
          {!selectedSupplier ? (
            <div className="flex flex-col items-center justify-center gap-2">
              ...
              <div className="p-4 text-center text-gray-500">
                Veuillez sélectionner un fournisseur pour voir ses transactions
              </div>
            </div>
          ) : (
            <>
              ...
              >
                ...
                <Tab key="all" title={<span>Tout</span>}>
                  {loading || !transactions ? (
                    <div className="space-y-3">
                      {Array(10)
                        .fill(null)
